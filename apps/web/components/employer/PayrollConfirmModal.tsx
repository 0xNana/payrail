  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        <div className="w-full max-w-2xl overflow-hidden rounded-[32px] border border-white/15 bg-[rgba(248,250,252,0.92)] shadow-[0_30px_120px_rgba(2,8,23,0.45)] backdrop-blur-2xl dark:bg-[rgba(7,18,36,0.94)]">
          <div className="flex items-start justify-between gap-4 border-b border-white/15 p-6">
            <div>
              <div className="section-label">Execution approval</div>
              <h2 className="mt-2 text-3xl font-semibold tracking-tight">Run payroll</h2>
          ...
          <div className="space-y-4 p-6">
            ...
            <div className={`rounded-[24px] border p-5 ${operatorOk ? "border-emerald-500/20 bg-emerald-500/10" : "border-destructive/30 bg-destructive/10"}`}>
              ...
              <div className="mt-3 text-xs text-muted-foreground space-y-2">
                <p>
                  ...
                  <code>operatorTransferEncrypted(employer, employee, encryptedSalary)</code>. That requires an operator
                ...
                <ul className="list-disc pl-5 space-y-1">
                  ...
                  <li>
                    Operator approval only lets the payroll contract move balances from your wallet when you explicitly submit payroll transactions.
                  </li>
                </ul>
            ...
            {/* What will be paid */}
            <div className="rounded-[24px] border border-white/20 bg-white/70 p-5 dark:border-white/10 dark:bg-white/5">
              <div className="flex items-center justify-between gap-3">
          ...
          {/* Actions */}
          <div className="flex flex-wrap items-center justify-between gap-3 border-t border-white/15 p-6">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              >
                {busy === "single" ? "Submitting…" : "Run single payroll"}
              </Button>
              ...
              >
                {busy === "batch" ? "Submitting…" : "Run batch payroll"}
              </Button>
            </div>
          </div>
        </div>
