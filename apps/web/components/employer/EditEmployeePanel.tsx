...
export function EditEmployeePanel(props: Props) {
  ...
  return (
    <Card className="col-span-2 border-white/40 bg-white/74 dark:border-white/10 dark:bg-[rgba(7,18,36,0.76)]">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <div>
            <div className="section-label">Employee edit surface</div>
      ...
      <CardContent className="space-y-5">
        ...
        <div className="space-y-3">
          <p className="section-label">{t.offchainSectionTitle}</p>
